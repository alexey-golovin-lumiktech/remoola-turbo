      ...
      <main className="flex-1">
        <header className="mb-5 flex items-center gap-3">
          <div className="relative w-full">
            <input placeholder="Search anything..." className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm shadow-sm outline-none focus:ring-2 focus:ring-blue-500" />
            <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-gray-400">⌘K</span>
          </div>
          <a href="/auth/logout" className="grid h-10 w-10 place-items-center rounded-full bg-white shadow-sm ring-1 ring-black/5">⎋</a>
        </header>
        {children}
      </main>
    </div>
