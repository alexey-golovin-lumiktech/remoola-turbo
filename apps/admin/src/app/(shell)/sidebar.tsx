  ...
  return (
    <div className="admin-sidebar h-[calc(100vh-3rem)] p-4 text-white shadow-xl">
      ...
      <nav className="mt-6 space-y-1">
        ...
        <SidebarLink href="/payments"   active={path.startsWith(`/payments`)}>Payments</SidebarLink>
        <SidebarLink href="/documents"  active={path.startsWith(`/documents`)}>Documents</SidebarLink>
      </nav>
